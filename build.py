...
EVENTS = [
    ...
    dict(n=27, title="Kubernetes and Friends Meetup — CNCF Hooghly",
         ...
         partners="Google, PrepVerse, Pollinations.ai", att="180", mode="On-Site"),
...
BLURBS = {
 ...
 27: "A CNCF-aligned Kubernetes and cloud-native meetup with a strong speaker lineup and 180 attendees. It connected campus students to the wider cloud-native community and its practitioners, extending the chapter's reach into professional DevOps circles.",
